 ...
 */
module.exports=class LatLonSpherical {
     ...
     */
    static distanceTo(point,point2, radius=6371e3) {
        ...
        const R = radius;
        const φ1 = point.lat.toRadians(),  λ1 = point.lon.toRadians();
        const φ2 = point2.lat.toRadians(), λ2 = point2.lon.toRadians();
        const Δφ = φ2 - φ1;
        const Δλ = λ2 - λ1;
...
//module.exports= { LatLonSpherical, Dms };
